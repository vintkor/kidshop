    ...
    <div class="row">
      <div class="col-md-6 auth">
        <ul>
          ...
          <li><a href="/wp-login.php?action=register">Зарегистрироваться</a></li>
          <?php endif ?>
        </ul>
      </div>
      <div class="col-md-6 align-right">
        <?php wp_nav_menu( array( 'theme_location' => 'super-top-menu') ); ?>       
      </div>
    </div>
  </div>
</nav>
        ...
        <div class="col-md-3 cart ">
          <div class="row">
            <div class="col-md-7">
              ...
              if($qty==0)
                    echo '<div><p>Ваша корзина ещё пуста</p></div>';
              // if single product in cart
              if($qty==1)
                    echo '<div><p>1 товар на сумму '.$total.'</p></div>';
              ?>
            </div>
            <div class="col-md-5">
